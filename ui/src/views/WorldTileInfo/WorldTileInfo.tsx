...
import { Container, PageHeader, PageHeaderTitle } from '@/atoms';
...
import { CreateBaseForm } from '@/views/CreateBaseForm/CreateBaseForm';
import { FoundCityForm } from '@/views/FoundCityForm/FoundCityForm';
...
export const WorldTileInfo: Component = () => {
    ...
    // TODO: move these states (as well as their modals) up into /touch/pages/CartographyPage/...
    // so that this component does not need to import anything from */touch/* and becomes a common one
